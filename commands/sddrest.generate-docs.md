...
```
/sddrest.generate-docs $ARGUMENTS
```
...
- Primary: `sdd-rest-java:java-documentation-specialist`
- If not available: Use `sdd-rest-java:java-documentation-specialist` or fallback to `general-purpose` agent
...
/sdd-rest-java:sddrest.generate-docs

# Generate API documentation only
/sdd-rest-java:sddrest.generate-docs . api html

# Generate documentation for specific project
/sdd-rest-java:sddrest.generate-docs /path/to/project full markdown

# Generate architecture documentation
/sdd-rest-java:sddrest.generate-docs . architecture asciidoc
```
