...
```
/sddrest.generate-crud $ARGUMENTS
```
...
- Primary: `sdd-rest-java:spring-boot-backend-development-expert`
- If not available: Use `sdd-rest-java:spring-boot-backend-development-expert` or fallback to `general-purpose` agent
...
/sdd-rest-java:sddrest.generate-crud Product

# Generate CRUD for User entity
/sdd-rest-java:sddrest.generate-crud User
