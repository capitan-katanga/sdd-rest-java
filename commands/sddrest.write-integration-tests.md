...
- Primary: `sdd-rest-java:spring-boot-unit-testing-expert`
- If not available: Use `sdd-rest-java:spring-boot-unit-testing-expert` or fallback to `general-purpose` agent with
  `spring-testing-fundamentals` skill
...
Follow these patterns from the spring-testing-fundamentals skill:
...
- **spring-testing-fundamentals** - Core integration testing patterns with Testcontainers and @ServiceConnection
- **spring-mvc-testing** - REST controller testing with MockMvc
...
- **spring-mvc-testing** - Testing `@ControllerAdvice` exception handlers
...
- **spring-security-testing** - Testing Spring Security and authorization
...
```bash
/sddrest.write-integration-tests example-input
```
