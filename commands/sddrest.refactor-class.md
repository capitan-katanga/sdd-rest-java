...
```
/sddrest.refactor-class $ARGUMENTS
```
...
/sdd-rest-java:sddrest.refactor-class src/main/java/com/example/service/UserService.java cleanup

# Full architectural refactoring with backup
/sdd-rest-java:sddrest.refactor-class src/main/java/com/example/service/OrderService.java comprehensive backup

# Performance optimization only
/sdd-rest-java:sddrest.refactor-class src/main/java/com/example/repository/ProductRepository.java performance

# Dry run to see what would change
/sdd-rest-java:sddrest.refactor-class src/main/java/com/example/controller/UserController.java architecture dry-run

# Automatic complex class detection
/sdd-rest-java:sddrest.refactor-class
```
