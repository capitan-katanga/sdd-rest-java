...
```
/sddrest.write-unit-tests $ARGUMENTS
```
...
- Use skill: `spring-testing-fundamentals`
...
- Use skill: `spring-security-testing`
- Test access control
...
- `spring-mvc-testing` - Testing exception handlers
...
- `spring-security-testing` - Testing security
- `spring-testing-fundamentals` - Testing service layer with Mockito
...
```bash
/sdd-rest-java:sddrest.write-unit-tests src/main/java/com/example/service/UserService.java
```
