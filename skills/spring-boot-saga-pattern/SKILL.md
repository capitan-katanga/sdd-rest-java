...
description: Provides distributed transaction patterns using the Saga Pattern for Spring Boot 4.x microservices. Use when implementing distributed transactions across services, handling compensating transactions, ensuring eventual consistency, or building choreography or orchestration-based sagas with Kafka, RabbitMQ, or Axon Framework. Targets Boot 4 / Spring Framework 7.
