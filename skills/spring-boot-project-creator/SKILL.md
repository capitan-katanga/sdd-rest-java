...
- Bootstrap a new Spring Boot 4.x project (Java 25, Jakarta EE 11) with a standard structure. Boot 3.x is supported as a secondary path for legacy projects.
...
- **Java Development Kit (JDK)**: Java 25 LTS recommended for Spring Boot 4.x (Java 21+ supported for legacy Boot 3.x flows)
...
```bash
# Example for Spring Boot 4.0.0 with PostgreSQL only
